...
public class LoginControllerTests {
    ...
    public void checkBadLoginResponse() throws IOException, URISyntaxException, InterruptedException {
        ...
        Assertions.assertTrue(checkLoginResponse.contains("Username was not found. Perhaps you forgot to register first?"));
    }
    ...
    public void checkWrongPasswordResponse() throws IOException, URISyntaxException, InterruptedException {
        ...
        Assertions.assertTrue(checkLoginResponse.contains("Password does not match. Try again."));
    }

    @Test
    @DisplayName("DELETE login response")
    public void deleteLoginResponse() throws IOException, URISyntaxException, InterruptedException {
        checkLoginResponse = RequestFactory.loginRequest("/login/delete","DELETE",null);
        Assertions.assertTrue(checkLoginResponse.contains("Password does not match. Try again."));
    }
